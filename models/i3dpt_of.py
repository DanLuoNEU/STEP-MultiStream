...
class I3D_head(torch.nn.Module):
    def __init__(self):
        super(I3D_head, self).__init__()

        self.maxPool3d = MaxPool3dTFPadding(
            kernel_size=(1, 3, 3), stride=(1, 2, 2), padding='SAME')
        # Mixed 5
        self.mixed_5b = Mixed(832, [256, 160, 320, 32, 128, 128])
        self.mixed_5c = Mixed(832, [384, 192, 384, 48, 128, 128])

class I3D_of(torch.nn.Module):
    def __init__(self,
                 num_classes,
                 dropout_prob=0,
                 name='inception'):
        super(I3D_of, self).__init__()

        self.name = name
        self.num_classes = num_classes
        in_channels = 2 # Optical Flow just 2 channels
