...
pretrain_path='/data/Dan/ava_v2_1/cache/Cls_distillation-max1-i3d-two_branch/20200528_541/checkpoint_best.pth'

name="STEP_distillation"
base_net="i3d"
det_net="two_branch"
resume_path="Auto"
...
python train_distillation.py --data_root $data_root --save_root $save_root --num_classes 3 \
